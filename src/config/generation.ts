export const GENERATION_MODEL = process.env.GENERATION_MODEL || 'anthropic/claude-sonnet-5';
...
Prefer quality over quantity. Return ${GENERATION_MIN_ENTRIES} to ${GENERATION_MAX_ENTRIES} entries.`;
